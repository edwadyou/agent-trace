"""instrument_anthropic.py

Use when your agent calls Claude via the anthropic SDK.

Quick start::

    pip install "agent-monitor[anthropic]"
    cp instrument_anthropic.py instrument.py
...
# ============== 3 KNOBS YOU EDIT ==============
SERVICE_NAME  = 'my-anthropic-agent'            # (1) trace identifier
INSTRUMENTORS = ['anthropic']            # (2) frameworks
