"""instrument_pure_no_framework.py

Use when your agent is hand-rolled with no framework SDK. This template uses the @span decorator from agent_monitor to emit spans manually. You still get the same JSONL output.

Quick start::

    pip install "agent-monitor"
    cp instrument_pure_no_framework.py instrument.py
...
# ============== 3 KNOBS YOU EDIT ==============
SERVICE_NAME  = 'my-pure-agent'            # (1) trace identifier
INSTRUMENTORS = []            # (2) frameworks
