"""instrument_google_genai.py

Use when your agent calls Gemini via google-generativeai.

Quick start::

    pip install "agent-monitor[google-genai]"
    cp instrument_google_genai.py instrument.py
...
# ============== 3 KNOBS YOU EDIT ==============
SERVICE_NAME  = 'my-google-genai-agent'            # (1) trace identifier
INSTRUMENTORS = ['google-genai']            # (2) frameworks
