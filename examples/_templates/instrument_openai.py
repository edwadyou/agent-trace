"""instrument_openai.py

Use when your agent talks to OpenAI directly through the openai SDK (no LangChain). The OpenAI instrumentor patches client.chat.completions.create() to emit LLM spans.

Quick start::

    pip install "agent-monitor[openai]"
    cp instrument_openai.py instrument.py
...
# ============== 3 KNOBS YOU EDIT ==============
SERVICE_NAME  = 'my-openai-agent'            # (1) trace identifier
INSTRUMENTORS = ['openai']            # (2) frameworks
