"""instrument_haystack.py

Use when your agent is built with Haystack pipelines.

Quick start::

    pip install "agent-monitor[haystack]"
    cp instrument_haystack.py instrument.py
...
# ============== 3 KNOBS YOU EDIT ==============
SERVICE_NAME  = 'my-haystack-agent'            # (1) trace identifier
INSTRUMENTORS = ['haystack']            # (2) frameworks
