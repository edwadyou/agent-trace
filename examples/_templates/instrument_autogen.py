"""instrument_autogen.py

Use when your agent is built with Microsoft autogen.

Quick start::

    pip install "agent-monitor[autogen]"
    cp instrument_autogen.py instrument.py
...
# ============== 3 KNOBS YOU EDIT ==============
SERVICE_NAME  = 'my-autogen-agent'            # (1) trace identifier
INSTRUMENTORS = ['autogen']            # (2) frameworks
