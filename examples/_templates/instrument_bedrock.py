"""instrument_bedrock.py

Use when your agent calls AWS Bedrock (boto3 bedrock-runtime client).

Quick start::

    pip install "agent-monitor[bedrock]"
    cp instrument_bedrock.py instrument.py
...
# ============== 3 KNOBS YOU EDIT ==============
SERVICE_NAME  = 'my-bedrock-agent'            # (1) trace identifier
INSTRUMENTORS = ['bedrock']            # (2) frameworks
