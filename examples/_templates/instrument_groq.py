...
Use when your agent calls LLMs through the Groq SDK.

Quick start::

    pip install "agent-monitor[groq]"
    cp instrument_groq.py instrument.py
...
# ============== 3 KNOBS YOU EDIT ==============
SERVICE_NAME  = 'my-groq-agent'            # (1) trace identifier
INSTRUMENTORS = ['groq']            # (2) frameworks
