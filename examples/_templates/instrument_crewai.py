"""instrument_crewai.py

Use when your agent is built with CrewAI (multi-agent crews).

Quick start::

    pip install "agent-monitor[crewai]"
    cp instrument_crewai.py instrument.py
...
# ============== 3 KNOBS YOU EDIT ==============
SERVICE_NAME  = 'my-crewai-agent'            # (1) trace identifier
INSTRUMENTORS = ['crewai']            # (2) frameworks
