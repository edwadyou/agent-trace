...
Use when your agent is built with DSPy programs.

Quick start::

    pip install "agent-monitor[dspy]"
    cp instrument_dspy.py instrument.py
...
# ============== 3 KNOBS YOU EDIT ==============
SERVICE_NAME  = 'my-dspy-agent'            # (1) trace identifier
INSTRUMENTORS = ['dspy']            # (2) frameworks
