# -*- coding: utf-8 -*-
"""Phase 3-5: insert flowchart helpers, radio, body wrap, IO side-by-side."""
import sys
...
# ===== Phase 3: insert flowchart helpers BEFORE "# LEFT tree renderer" =====
helpers_marker = "# LEFT tree renderer"
assert helpers_marker in content, "Phase 3 marker missing"
...
print(f"After Phase 3: {len(content.encode('utf-8'))} bytes")